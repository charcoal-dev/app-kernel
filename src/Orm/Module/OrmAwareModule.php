 ...
 */
abstract class OrmAwareModule extends AppAwareContainer implements RuntimeCacheOwnerInterface,
    CacheStoreOperationsInterface
{
    ...
    abstract public function resolveCipherFor(OrmAwareRepository $resolveFor): ?Cipher;
